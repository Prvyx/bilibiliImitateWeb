 ...
 * @description: 通过userId获得至多4个视频信息 的实体类
 * @author: Prvyx
 * @created: 2022/03/25 11:40
 */

public class Video4ByUserId {
    ...
    public Video4ByUserId() {
    }

    public Video4ByUserId(String video_id, String video_title, String video_img_path, String video_play_count, String video_datetime) {
