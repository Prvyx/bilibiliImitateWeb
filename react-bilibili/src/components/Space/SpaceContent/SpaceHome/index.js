...
import {Button, Card, Col, Descriptions, Divider, Form, Image, Layout, List, Row, Tabs, Upload} from "antd";
...
import SpaceHomeSider from "./SpaceHomeSider";
    ...
    render() {
        ...
        return (
            <Layout>
                ...
                <SpaceHomeSider spaceHomeSiderProps={spaceHomeSiderProps}/>
            </Layout>
        );
    }
}
